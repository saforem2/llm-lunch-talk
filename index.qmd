...
::: {style="text-shadow: 0px 0px 10px RGBA(0, 0, 0, 0.35); background-color: rgba(8, 42, 123, 0.7); border-radius: 10px; text-align:left; padding: 1.5rem; margin-left: auto; margin-right: auto; line-height: 1.5em!important; box-shadow: RGBA(0, 0, 0, 0.25) 0px 5px 15px;"}
...
# Recent Work (2017 -- Now) {.scrollable style="max-height: 90%;"}
...
# Getting Started at ALCF {style="font-size: 0.85em;"}
...
<!-- [{{< fa solid person-chalkboard size=fa-lg >}}]{style='color:var(--dim-text);'} $\hspace{1pt}$ [Recent Talks]{.dim-text} -->
