...
format:
  revealjs:
    ...
    theme: [css/common.scss, css/light.scss, css/syntax-light.scss]
...
[October 10 -- 12, 2023 $\hspace{5pt}$ {{< fa solid shapes >}}]{style="font-size: 1.80em; font-weight: 600; border-bottom: 1px solid white; color: #F8F8F8"} [![](./assets/anl_logo.svg)]{style="display:inline-block;"}

:::

[ALCF Hands-on]{style="font-size: 3.2em; font-weight: 700; color: white"}  
<br>
[HPC Workshop]{style="font-size: 3.2em; font-weight: 700; color: #FFFFFF"}  
...
[October 10 -- 12, 2023 $\hspace{5pt}$ {{< fa solid shapes >}}]{style="font-size: 1.80em; font-weight: 600; border-bottom: 1px solid white; width: 80%; color: #F8F8F8"} [![](./assets/anl_logo.svg)]{style="display:inline-block;"}
...
<!-- ::: footer -->
<!---->
<!-- [[{{< fa brands github >}}]{.code-text} <a href="https://github.com/argonne-lcf/ALCF_Hands_on_HPC_Workshop">[argonne-lcf/ALCF_Hands_on_HPC_Workshop]{.code-text}</a>]{style="font-size: 1.5rem; text-shadow: RGBA(0, 0, 0, 0.45) 0px 0px 10px;"} -->
<!---->
<!-- ::: -->
...
[October 10 -- 12, 2023 $\hspace{5pt}$ {{< fa regular triangle >}} {{< fa solid shapes >}}]{style="font-size: 1.75em; border-bottom: 1px solid white; width: 80%; color: #F8F8F8"} [![](./assets/anl_logo.svg)]{style="display:inline-block;"}
...
::: {layout="[ 35, -5, 60 ]" layout-valign="bottom"}
...
# Landmark Papers (2017 -- Now) {.scrollable style="font-size:0.8em; max-height: 90%;"}
